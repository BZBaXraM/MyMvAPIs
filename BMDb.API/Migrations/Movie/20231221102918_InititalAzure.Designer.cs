...
namespace BMDb.API.Migrations.Movie
{
    ...
    [Migration("20231221102918_InititalAzure")]
    partial class InititalAzure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BMDb.API.Models.Movie", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c47befd8-5917-4176-bd5a-c08532f53964"),
                        ...
                        new
                        {
                            Id = new Guid("f27226f8-74ea-4173-ab74-45fb6b3fc834"),
                        ...
                        new
                        {
                            Id = new Guid("e45a7c99-1461-40da-8847-ca0a4c90c485"),
                        ...
                        new
                        {
                            Id = new Guid("c98f0095-5964-45f9-97b9-995fcffbf327"),
                            Director = "Christopher Nolan",
                        ...
                        new
                        {
                            Id = new Guid("a299f9f6-0ae8-4227-ac40-741511b033e9"),
                            Director = "Francis Ford Coppola",
                            Genre = "Crime, Drama",
                            ImdbId = "tt0071562",
                        ...
                        new
                        {
                            Id = new Guid("46e42c8a-a69c-4732-ae74-b755bca50144"),
                        ...
                        new
                        {
                            Id = new Guid("f8fd4904-0852-421e-8248-cb563c9f4c3b"),
                        ...
                        new
                        {
                            Id = new Guid("48cedb4a-1433-493a-9d3b-28126c1941c6"),
                        ...
                        new
                        {
                            Id = new Guid("98b08d75-7246-4a67-ab38-f1d96f894197"),
                        ...
                        new
                        {
                            Id = new Guid("3ca6c99b-7fc2-43b0-b254-0e82f7875f3f"),
                        ...
                        new
                        {
                            Id = new Guid("54ab3c5e-d3d0-471e-906f-f206f25f5a29"),
                            Director = "Sam Raimi",
                        ...
                        new
                        {
                            Id = new Guid("68f03f46-a62a-4ddc-aae9-cef15d71a313"),
                            Director = "Sam Raimi",
                            Genre = "Action, Adventure, Sci-Fi",
                            ImdbId = "tt0316654",
                        ...
                        new
                        {
                            Id = new Guid("9aeefc71-b962-4f7e-a592-8e32b3f40f11"),
                            Director = "Sam Raimi",
                            Genre = "Action, Adventure, Sci-Fi",
                            ImdbId = "tt0413300",
                        ...
                        new
                        {
                            Id = new Guid("dbacc999-151d-4e5f-b7e3-858d04f25fd5"),
                        ...
                        new
                        {
                            Id = new Guid("85f9e5da-2faa-414f-9b25-4e57297c649a"),
                        ...
                        new
                        {
                            Id = new Guid("75df6583-04eb-4e59-a961-9be1eb99b392"),
                            Director = "David Fincher",
