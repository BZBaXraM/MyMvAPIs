...
/// <summary>
/// AzureMovieService class.
/// </summary>
public class AzureMovieService : IAsyncMovieService
{
    private readonly AzureMovieContext _context;

    /// <summary>
    /// AzureMovieService constructor.
    /// </summary>
    /// <param name="context"></param>
    public AzureMovieService(AzureMovieContext context)
        => _context = context;
